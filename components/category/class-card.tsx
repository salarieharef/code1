      ...
      <Link href={link} title={title}>
        <CardContent className='flex flex-col items-center justify-center p-2'>
          <ResponsiveImage
            ...
            sizes={sizes}
            containerClassName='aspect-[5/4] rounded-2xl w-full h-full md:aspect-square'
          />
          ...
          <div className='mt-1  w-full overflow-hidden text-right text-base font-medium text-slate-700 dark:text-slate-200 sm:truncate sm:whitespace-nowrap lg:text-lg '>
          ...
          <div className='mt-2 flex min-h-10 w-full flex-row justify-between px-2  py-0'>
