...
export default function RecommendationLessons() {
  ...
  // 	isLoading,
  // } = useSWR(
  // 	routes.userRoutes.recommendationLessons({ page: page }),
  // 	fetcher,
  // 	{
      ...
      <div className='space-between mt-6 grid gap-x-8 gap-y-4 sm:grid-cols-2 md:grid-cols-3'>
        {isLoading || error ? (
          ...
          <div className='col-span-full flex h-full w-full flex-col items-center justify-center'>
            ...
            <span>
              جلسات مورد علاقه خود را مشاهده کنید تا پیشنهاد جلسات با کیفیت
              بهتری در پیشنهادات شما قرار بگیرد.
            </span>
          </div>
        ) : (
